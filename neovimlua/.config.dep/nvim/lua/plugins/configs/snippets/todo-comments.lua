...
-- NOTE: All this is stolen from https://github.com/L3MON4D3/LuaSnip/wiki/Cool-Snippets#all---todo-commentsnvim-snippets
...
_G.luasnip.vars = {
  username = 'natdm',
  github = 'https://github.com/natdm',
  real_name = 'Nathan Hyland',
}
